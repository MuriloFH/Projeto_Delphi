...
//procedure para atualizar o valor das outras procedures que puxam informação do banco
procedure TfrmCadastrosNumeros.DataSource1StateChange(Sender: TObject);
begin
 if DataSource1.State in [dsBrowse] then
  CalculaTotais;
  QuantidadeCadastros;  //não está att o total de cadastros
  //depois de colocar o evento State Change no dataSourse não está mais permitindo cadastrar
end;
